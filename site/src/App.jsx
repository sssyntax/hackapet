        ...
        <div className="flex flex-wrap justify-center items-center gap-8 mt-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-black mx-5">
            <div className="border-dashed border-4 border-darkBlue p-4">
              ...
              <p className="text-lg neuebit">Includes wifi  capabilities!</p>
            </div>
            <div className="border-dashed border-4 border-darkBlue p-4">
              <p className="text-sm text-darkBlue">Screen</p>
              <p className="text-lg neuebit">1.5in 128x128 pixels full color oled</p>
            </div>
            <div className="border-dashed border-4 border-darkBlue p-4">
              <p className="text-sm text-darkBlue">Dimensions</p>
              <p className="text-lg neuebit">5.6x6.6cm - the size of an actual tamagotchi!</p>
            </div>
            <div className="border-dashed border-4 border-darkBlue p-4">
              <p className="text-sm text-darkBlue">Extras!</p>
              <p className="text-lg neuebit">3 tactile buttons 3 LEDs for you to program</p>
            </div>
            <div className="border-dashed border-4 border-darkBlue p-4">
              <p className="text-sm text-darkBlue">Hackable!</p>
              <p className="text-lg neuebit">16 pins broken out to add anything on</p>
            </div>
            <div className="border-dashed border-4 border-darkBlue p-4">
              <p className="text-sm text-darkBlue">Battery - 2xAAA</p>
              <p className="text-lg neuebit">Lasts around 8 hours*</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 text-lightBlue text-xl mt-8 mx-5 xl:mx-44 gap-8">
          <div className="">
            <div className="border-4 border-dashed border-lightBlue p-8 text-sm">
              <p className="text-2xl mb-4 neuebit-body">How do I make a game?</p>
              <p className="neuebit">For this, we'll be using <a href="https://circuitpython.org/" className="link" target="_blank" rel="noopenner noreferrer">CircuitPython</a>! It's a programming language similar to Python, used on microcontroller boards.</p>
              <p className="mt-4 neuebit">You'll also need to use <a href="https://pypi.org/project/blinka-displayio-pygamedisplay/" target="_blank" rel="noopenner noreferrer">this library</a>, which allows you to output CircuitPython displayio code to a pygame window on PC, instead of a hardware display.</p>
              <p className="mt-4 neuebit">To set that up, make a virtual enviorment by using the commands below (for macOS and Linux only!) (further instructions <a href="https://pypi.org/project/blinka-displayio-pygamedisplay/" target="_blank" rel="noopenner noreferrer">here</a>):</p>
              ...
              <p className="mt-4 neuebit">For getting keyboard inputs, I use pygame. When you get the actual device, you'll need to switch out any pygame code for circuitpython.</p>
            </div>
            <div className="border-4 border-dashed border-lightBlue p-8 mt-8 text-sm">
              <p className="text-2xl mb-4 neuebit-body">How do I draw pixel art?</p>
              <p className="neuebit">I use <a href="https://www.aseprite.org/" target="_blank" rel="noopenner noreferrer">Aseprite</a>, a pixel art app! You can get it for free by compiling it yourself <a href="https://github.com/aseprite/aseprite/blob/main/INSTALL.md" target="_blank" rel="noopenner noreferrer">here</a>.</p>
              <p className="mt-4 neuebit">Don't want to compile anything? Download <a href="https://libresprite.github.io/#!/" target="_blank" rel="noopenner noreferrer">Libresprite</a>, an older version of Aesprite! Should work similarily.</p>
              <p className="mt-4 neuebit">Don't want to download anything? <a href="https://www.piskelapp.com/" target="_blank" rel="noopenner noreferrer">Piskel</a> is an online pixel art editor.</p>
              <p className="mt-4 neuebit">Some asset suggestions:</p>
              ...
              <p className="mt-4 neuebit">After you're done drawing, download your files as .bmp</p>
              <p className="mt-4 neuebit">For animations, download the entire animation as a singular sprite sheet file. You can cut it into frames in code!</p>
              <img src="/cat-Sheet.png" className="w-full mt-4"/>
              <p className="opacity-70 mt-2 neuebit"><i>Here's the sprite sheet for the idle animation of my pet!</i></p>
            </div>
          </div>


          <div className="border-4 border-dashed border-lightBlue p-8 text-sm neuebit-body">
            <p className="text-2xl mb-4 neuebit">How do I submit my game?</p>
            ...
            <a href="https://github.com/hackclub/hackapet" target="_blank" rel="noopenner noreferrer"><button className="p-4 bg-lightPink text-black rounded-sm mt-4 neuebit">Submit your game by making a pull request!</button></a>
            <p className="mt-2 neuebit">Questions? Ask in <a href="https://hackclub.slack.com/archives/C0809PN4TPE" target="_blank" rel="noopenner noreferrer">#hackapet</a> in the Hack Club Slack!</p>
          </div>
