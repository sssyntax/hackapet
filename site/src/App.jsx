  ...
  return (
    <>
      ...
      <div className="my-12 bg-darkBlue py-12">
        ...
        <p className="text-lightBlue flex flex-col justify-center text-center mx-5 mt-4">Hackapet isn't for sale! As long as you're a teenager, an original game and we'll personally mail you one for free - "you ship, we ship!"</p>
